          ...
          <div className='grid place-items-center'>
            <div className='w-[90%] m-[12px] grid grid-cols-2 grid-rows-2 gap-[32px]'>
              ...
              <div>
                ...
                >
                  {data?.birthTime
                    ? moment(data?.birthTime).format('HH:mm:ss')
                    : 'NA'}
                </h1>
              </div>
              <div>
    ...
    return (
      <>
        <div
          className={
            upgradeDone
              ? `w-full 2xl:h-[353px] xl:h-[353px] lg:h-[353px] md:h-[353px] h-[370px] border-[1px] border-[#F1F1F1] rounded-[10px]  2xl:space-y-[20px] xl:space-y-[20px] lg:space-y-[20px] md:space-y-[20px] space-y-[10px]`
              : `w-full 2xl:h-[353px] xl:h-[353px] lg:h-[353px] md:h-[353px] h-[370px] border-[1px] border-[#F1F1F1] rounded-[10px]  2xl:space-y-[20px] xl:space-y-[20px] lg:space-y-[20px] md:space-y-[20px] space-y-[10px]`
          }
        >
          <div className='pt-[10px] grid place-items-center'>
              ...
              <div>
                ...
                >
                  {data && data.userEducation?.degree
                    ? capitalizeFirstLetter(data.userEducation.degree)
                    : 'NA'}
                </h1>
              </div>
              <div>
                ...
                >
                  {data && data.userEducation?.collage
                    ? capitalizeFirstLetter(data?.userEducation?.collage)
                    : 'NA'}
                </h1>
              </div>
              <div>
                ...
                >
                  {data && data.userEducation?.city
                    ? capitalizeFirstLetter(data?.userEducation?.city)
                    : 'NA'}
                </h1>
              </div>
              <div>
                ...
                >
                  {data && data.userEducation?.state
                    ? capitalizeFirstLetter(data?.userEducation?.state)
                    : 'NA'}
                </h1>
              </div>
              <div>
                ...
                >
                  {data && data.userEducation?.country
                    ? capitalizeFirstLetter(data?.userEducation?.country)
                    : 'NA'}
                </h1>
              </div>
            </div>
              ...
              <div>
                ...
                >
                  {data && data.userProfessional?.companyName
                    ? capitalizeFirstLetter(data?.userProfessional?.companyName)
                    : 'NA'}
                </h1>
              </div>
              <div>
              ...
              <div>
                ...
                >
                  {data && data.userProfessional?.workCity
                    ? capitalizeFirstLetter(data?.userProfessional?.workCity)
                    : 'NA'}
                </h1>
              </div>
              <div>
                ...
                >
                  {data && data.userProfessional?.workCountry
                    ? capitalizeFirstLetter(data?.userProfessional?.workCountry)
                    : 'NA'}
                </h1>
              </div>
            </div>
  ...
  return (
    <>
      ...
      <div className='2xl:pl-0 2xl:pr-0 xl:pl-0 xl:pr-0 lg:pl-[0px] lg:pr-[30px] pl-[0px] pr-[20px] relative 2xl:left-[40px] xl:left-[45px] lg:left-0 left-[0px]'>
        ...
        >
          <div className='ml-[-5px] mt-[-3px] bg-custom-gradient w-full h-[100px] 2xl:h-[138px] xl:h-[138px] md:h-[138px] lg:h-[138px] bg-[#0F52BA] rounded-[10px]'>
            ...
            <div className='space-y-[5px]'>
                    ...
                    <div className='flex items-center space-x-[10px]'>
                      ...
                      >
                        {capitalizeFirstLetter(user?.address?.currentCity) ||
                          'NA'}
                        ,{' '}
                        {capitalizeFirstLetter(user?.address?.currentCountry) ||
                          'NA'}
                      </h1>
                    </div>
                  </li>
              ...
              <div className='relative left-[5px] hidden lg:flex space-x-[25px] 2xl:space-x-[20px] xl:space-x-[20px] lg:space-x-[35px] pt-[20px]'>
                <div
                  ...
                  className={`${
                    ActiveTab === 1 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer  flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='18'
                    height='18'
                ...
                <div
                  ...
                  className={`${
                    ActiveTab === 2 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='18'
                ...
                <div
                  ...
                  className={`w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer   ${
                    ActiveTab === 3 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='18'
                    height='18'
                ...
                <div
                  ...
                  className={`w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer   ${
                    ActiveTab === 4 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='28'
                ...
                <div
                  ...
                  className={`w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer   ${
                    ActiveTab === 5 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='18'
                ...
                <div
                  ...
                  className={`w-[50px] h-[50px] 2xl:w-[54px] 2xl:h-[54px] xl:w-[45px] xl:h-[45px] cursor-pointer   ${
                    ActiveTab === 6 ? 'bg-[#0F52BA]' : 'bg-[#F8F8F8]'
                  } flex items-center justify-center rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='18'
                ...
                <div
                  ...
                  className={`w-[200px] h-[50px] cursor-pointer  ${
                    ActiveTab === 7
                      ? 'bg-[#0F52BA] text-[#FFF]'
                      : 'bg-[#F8F8F8] Text-[#000]'
                  } flex justify-center items-center space-x-[15px] rounded-[27px] hover:bg-[#F3F8FF]`}
                >
                  <svg
                    width='19'
                    height='18'
