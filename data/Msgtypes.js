          ...
          >
            <Stack spacing={2}>
              ...
              >
                ...
                />
                <Stack spacing={2}>
                  <Typography style={messageText} variant='subtitle2'>
                    Creating Chat App
                  </Typography>
                  <Typography
                    style={messageText}
                ...
                >
                  ...
                  >
                    {userMessage.message.length > 65 ? (
                      <>
                        {userMessage.message.slice(0, 65)} {<br />}{' '}
...
const TextMsg = ({ el, Outgoing, userMessage, sendAt, onDeleteMessage }) => {
  ...
  const displayedMessage = showFullMessage
    ? userMessage?.message
    : userMessage?.message?.substring(0, MAX_LENGTH)
      ...
      {Outgoing ? (
        ...
        >
          <Box
            p={2}
            sx={{
              backgroundColor: darkMode ? '#7D5C8D' : '#F8E8FF',
              borderRadius: '18px',
          ...
          >
            <Typography variant='body2' color={darkMode ? '#FFF' : '#000'}>
              {displayedMessage}
              {isLongMessage && (
                <span
        ...
        >
          <Box
            p={2}
            sx={{
              backgroundColor: darkMode ? '#455978' : '#E1EDFF',
              borderRadius: '18px',
              maxWidth: showFullMessage ? '50%' : '50%',
              wordWrap: 'break-word',
              wordBreak: 'break-word',
          ...
          >
            <Typography variant='body2' color={darkMode ? '#FFF' : '#000'}>
              ...
              <div className='flex items-center justify-start'>
                <div className='p-[5px] text-right'>
                  <h1 className='text-[#000] dark:text-[#FFF]' style={TimeText}>
                    {getMessageTime(sendAt)}
                  </h1>
                </div>
                {/* <div>
        ...
        <div className='2xl:w-[333px] 2xl:h-[272px] xl:w-[300px] xl:h-[200px] lg:w-[300px] lg:h-[200px] w-[333px] h-[272px]  rounded-[14px] border-[1px] border-[#E5BDF8] bg-[#FAF0FF]'>
          ...
          >
            ...
            <div className='flex space-x-[9px]'>
              {[0, 1, 2].map(res => {
                return (
                  <>
                    <div
                      className={`rounded-[50%] w-[10px] h-[10px] bg-[#8225AF] ${
                        Tab == res ? '' : 'opacity-[0.1]'
                      }`}
                    ></div>
                  </>
            ...
            <div>
              <button
                className={`${
                  Tab >= 2 ? 'w-[147px]' : 'w-[73px]'
                } h-[34px] bg-[#0F52BA] rounded-[23px] text-[#FFF]`}
                onClick={HandleNext}
              >
          ...
          >
            ...
            <div>
              <button id='audio-button' onClick={handlePlayPause}>
                <span>
                  {isPlaying ? (
                    <img src='/assests/song/Pause-icon.svg' />
                  ) : (
                    <img src='/assests/song/Play-icon.svg' />
                  )}
                </span>
              </button>
            </div>
