...
const PartnerPreferenceTab = dynamic(() =>
  import('./sections/PartnerPreferenceTab')
)
const GeneralTab = dynamic(() => import('./sections/GeneralTab'))
...
function Profile () {
  ...
  const { data: ProfessionalData } = useSelector(
  ...
  const RenderTab = () => {
    switch (ActiveTab) {
      ...
      case 6:
        ...
        break
      case 7:
        return <PartnerPreferenceTab partnerPrefID={data?.userPartner} />
        break
    }
  }
  ...
  return (
    <>
      ...
      <div className=' dark:bg-[#18191a] 2xl:pl-0 2xl:pr-0 xl:pl-0 xl:pr-0 lg:pl-[0px] lg:pr-[30px] pl-[0px] pr-[20px] relative 2xl:left-[40px] xl:left-[45px] lg:left-0 left-[0px]'>
        ...
        >
          <div className='bg-custom-gradient w-full h-[100px] 2xl:h-[138px] xl:h-[138px] md:h-[138px] lg:h-[138px] bg-[#0F52BA] rounded-[10px]'>
            <div className='flex justify-between pb-[50px]'>
              ...
              >
                <span className=' h-12 w-12 text-lg text-white '>
            ...
            <div className='dark:bg-[#18191a] space-y-[5px]'>
                  ...
                  <li>
                    <div className='flex items-center space-x-[10px]'>
                      ...
                      <h1
                        ...
                        className='dark:text-[#FFF] lg:text-[12px] md:text-[12px] text-[11px]'
                      >
                        {capitalizeFirstLetter(ProfessionalData?.jobTitle) ||
                          'NA'}
                      </h1>
                    </div>
                  </li>
                  <li>
                    <div className='flex items-center space-x-[10px]'>
                      ...
                      <h1
                        ...
                        className='dark:text-[#FFF] lg:text-[12px] md:text-[12px] text-[11px]'
                      >
                        {capitalizeFirstLetter(addressData?.currentCity) ||
                          'NA'}
                      </h1>
                    </div>
                  </li>
              ...
              <div className='text-center pt-[10px]'>
                <p
                  ...
                  style={Text2}
                >
                  {capitalizeFirstLetter(data?.writeBoutYourSelf) ||
                    'About yourSelf'}
                </p>
              </div>
