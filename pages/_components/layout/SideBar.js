...
function SideBar () {
  ...
  const OnCopied = () => {
    ...
    navigator.clipboard
      .writeText(myProfile?.userUniqueId?.toUpperCase())
      .then(() => {
        Setcopied(true)
            ...
            <div>
              ...
              <div className='pt-[10px] flex space-x-2'>
                ...
                <Link href='/longterm/dashboard/profile'>
                  <span className='text-[14px] text-[#0F52BA] dark:text-[#FFF]'>
                    My Profile
                  </span>
                </Link>
              </div>
          ...
          <ul className='relative left-[-10px] space-y-[10px] pb-[20px] font-medium border-t  border-gray-200 dark:border-[#292929] p-[10px]'>
            <li
              ...
              className={`duration-100 ${
                darkMode ? '' : 'hover:bg-[#F2F7FF]'
              } rounded-[17px] p-[5px] pl-[10px] flex items-center`}
            >
              <span>
            ...
            <li
              className={`${
                darkMode ? '' : 'hover:bg-[#F2F7FF]'
              } duration-100 rounded-[17px] p-[5px] pl-[10px] flex items-center`}
            >
              ...
              <div
                className={`${
                  router.pathname === '/longterm/dashboard/accepted'
                    ? 'invisible'
                    : 'visible	'
                } flex justify-end  w-full pr-[10px]`}
              >
                {/* <div
                  id="grad-btn"
            ...
            <li
              className={`${
                darkMode ? '' : 'hover:bg-[#F2F7FF]'
              } duration-100 rounded-[17px] p-[5px] pl-[10px] flex items-center relative left-[-1px] `}
            >
                ...
                <h1
                  ...
                  className={`text-[14px]  dark:hover:text-[#FFF] pl-[6px]  
                   ${
                     darkMode
                       ? router.pathname ===
                         '/longterm/dashboard/recentlyviewed'
                         ? 'text-[#FFF]'
                         : 'text-[#7D7F86]'
                       : router.pathname ===
                         '/longterm/dashboard/recentlyviewed'
              ...
              <div
                className={`${
                  router.pathname === '/longterm/dashboard/newrequest'
                    ? 'invisible'
                    : 'visible	'
                } flex justify-center relative 2xl:left-[50px] lg:left-[50px] xl:left-[40px]`}
              >
            ...
            >
              ...
              <Link href='/longterm/dashboard/shortlists'>
                ...
                <h1
                  ...
                  className={` ${
                    notificatindot.newShortlists > 0 &&
                    'inline relative left-[0px]'
                  }  text-[14px] pl-[10px]  dark:hover:text-[#FFF]
                  ${
                    darkMode
                      ? router.pathname === '/longterm/dashboard/shortlists'
                        ? 'text-[#FFF]'
