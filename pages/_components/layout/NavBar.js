...
const RequestNotification = dynamic(
  () =>
    import('../../../components/long-term/Notification/RequestNotification'),
  {
    ssr: false
  }
)
...
function NavBar ({ handleSearch }) {
  ...
  const list = () => (
    <Box>
      <div
        className={`scroll-req-content  h-full  bg-[#FFF] 2xl:w-[340px] w-[350px] xl:w-[300px] `}
      >
        <Chats
      ...
      >
        <Stack direction='row' sx={{ width: '100%' }}>
          ...
          <Box
            sx={{
              height: '100%',
              width: Wide ? 'calc(100vw - 320px)' : 'calc(750px - 300px)',
  ...
  const isUpgradeActive = router.pathname.startsWith(
    '/longterm/dashboard/upgrade'
  )
          ...
          <div className='ml-[5%]'>
            <div className='flex space-x-[20px]   pt-[20px] pb-[20px]'>
              ...
              <div>
                ...
                <p style={userStatus} className='text-[#0091FF]'>
                  Online
                </p>
              </div>
  ...
  const navList = (
    <ul className='mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 lg:justify-end lg:gap-x-[50px]'>
      <div className='p-1 font-normal poppins rounded-[10px]'>
        {isUpgradeActive ? (
          ''
        ) : (
          <>
      ...
      >
        <Image
          ...
          src={
            darkMode
              ? '/assests/dashboard/icon/chat-icon-dark.svg'
              : '/assests/dashboard/icon/chat-icon-light.svg'
          }
        />
      </div>
      <div
      ...
      >
        <Badge badgeContent={notificationCount} color='primary'>
          <Image
            ...
            src={
              darkMode
                ? '/assests/dashboard/icon/notification-icon-white.svg'
                : '/assests/dashboard/icon/notification-icon.svg'
            }
          />
        </Badge>
      </div>
      <div id='nav-links' className='p-1 font-normal rounded-[10px] p-[7px]'>
        <ProductsListModal />
      </div>
      <div
        id='nav-links'
      ...
      >
        <div
          className='grid place-items-center w-[45px] h-[45px]'
            ...
            <div className='pt-[20px] w-[278px] h-[449px]' style={BoxSdow2}>
              <div className='flex flex-col space-y-[20px]'>
                    ...
                    {isUpgradeActive ? (
                      <>
                        <ul className='relative right-[18px] flex items-center space-x-[10px]'>
                          ...
                          <li style={planPrice2} className='text-[12px]'>
                            <h1>Gold</h1>
                          </li>
                        </ul>
                        <h1 style={planPrice} className='text-[12px]'>
                          One Month
                        </h1>
                      </>
                    ) : null}
                ...
                <div className='pl-[28px] '>
                  <h1
                    style={UserProfileName}
                    className='text-[#000] dark:text-[#FFF]'
                  >
                    {myProfile?.name}
                  </h1>
                  <p style={userId} className='text-[#50545A]'>
                ...
                <div className='relative left-[-10px] pt-[0px] flex items-center flex-col space-y-[23px]'>
                  <ul
                    style={Text4}
                    className=' dark:text-[#FFF] pl-[0px] text-[#000] space-y-[8px]'
                  >
                    ...
                    <li className='w-[230px] h-[34px] p-[10px] pl-[15px] hover:bg-[#F3F8FF] dark:hover:bg-[#18191a] rounded-[100px]  flex items-center space-x-[10px]'>
                      ...
                      <Link
                        className='relative left-[5px]'
                        href='/longterm/dashboard/seting/credentials'
                      >
                        Account Settings
                      </Link>
                    </li>
                    <li className='w-[230px] h-[34px] p-[10px] pl-[15px] hover:bg-[#F3F8FF] dark:hover:bg-[#18191a] rounded-[100px]  flex items-center space-x-[10px]'>
                      <span>
                        {darkMode
                          ? icons['menu-lock'].dark
                          : icons['menu-lock'].light}
                      </span>

                      <Link
                        className='relative left-[5px]'
                        href='/longterm/dashboard/seting/privacyseting'
                      >
                        Privacy Setting
                      </Link>
                    </li>
                  ...
                  <div
                    ...
                    className='relative left-[10px] flex justify-center'
                  >
                    <button
    ...
    <>
      ...
      >
        <div className='flex items-center flex-row-reverse lg:flex-row justify-between'>
          <div className='mr-4 cursor-pointer py-1.5 lg:ml-[0px] font-medium'>
            <Link href='/'>
              {' '}
              <Image
                quality={45}
                ...
                src={
                  darkMode
                    ? '/heroSec/new-logo-white.svg'
                    : '/heroSec/Happy-milan2.svg'
                }
              />
            </Link>
          </div>
            ...
            {isUpgradeActive ? (
              ...
              <>
                ...
                <input
                  ...
                  className='hover:border-[black] text-[#000] dark:text-[#FFF] outline-none   pl-[40px] w-[200px] h-[40px] rounded-[23px] bg-none border-[1px] border-[#E3E3E3]  dark:bg-[#242526]  ouline-none focus:border-[1px] focus:border-[black] pr-[10px]'
