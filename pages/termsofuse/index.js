...
function index () {
  ...
  return (
    <>
      <AuthNavbar />
      <div className='pt-[100px] md:pt-[100px] lg:pt-[100px] xl:pt-[140px] mb-[50px] lg:mb-[60px] h-full  lg:grid place-items-center '>
        <div className='lg:pr-0 lg:pl-0 pr-[20px] pl-[20px] w-full lg:w-[900px] text-left'>
          <h1 className='text-[34px] md:text-[44px] font-semibold md:text-center'>
            Terms of Use & Service Agreement
          </h1>
        </div>

        <div className='lg:pr-0 lg:pl-0 pl-[20px] pr-[20px] mt-[20px] w-full grid place-items-center md:block lg:w-[900px]'>
          <div>
          ...
          <div>
            ...
            <ul style={ContentText}>
              <li>
                ...
                <span className='text-[#0F52BA]'>
                  {' '}
                  HappyMilan login credentials.
                </span>{' '}
                Ensure limited access to your device to prevent unauthorized
                account entry. Do not share your password, as the company does
                not request it.
              </li>
              <li className='mt-[21px]'>
              ...
              <li className='mt-[21px]'>
                You are solely responsible for any activity that occurs under
                your account
              </li>
            </ul>
          </div>
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              ...
              <li className='mt-[21px]'>
                You will not post content that is offensive, defamatory, or
                violates the rights of others.
              </li>
              <li className='mt-[21px]'>
                You will not use the website for any commercial purposes without
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              ...
              <li className='mt-[21px]'>
                You acknowledge that your profile information may be shared with
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                We reserve the right to modify, update, or change the terms of
                this Agreement at any time without prior notice. Your continued
                use of the services after such modifications constitutes
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                ...
                our discretion, without notice, for any conduct that we believe
                violates this Agreement or is harmful to other users or us.
              </li>
            </ul>
          </div>
          <div className='w-[100%] h-[1px] bg-[#CCC] mt-[20px]'></div>
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                You can terminate your membership anytime by deleting your
                profile or contacting HappyMilan.com. No refunds for unused
                subscription fees unless expressly guaranteed in writing
              </li>
              <li className='mt-[21px]'>
                If the business is disrupted, the Company will reimburse you
                with 50% of the unused membership fees you've paid.
              </li>
              <li className='mt-[21px]'>
                HappyMilan.com may terminate your access or membership for
                reasons like violating terms, commercial use, prohibited
                communication, or inappropriate activity. Termination notice
                will be sent to your provided email, and no refund of
                subscription fees will be granted for breaches of the agreement.
              </li>
            </ul>
          </div>
          <div className='w-[100%] h-[1px] bg-[#CCC] mt-[20px]'></div>
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                Any disputes arising out of or relating to this Agreement will
                be resolved through binding arbitration in accordance with the
                Arbitration and Conciliation Act, 1996, and the venue for
                arbitration shall be Ahmedabad, India
              </li>
            </ul>
          </div>
          <div className='w-[100%] h-[1px] bg-[#CCC] mt-[20px]'></div>
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                This Agreement complies with the provisions of the Information
                Technology Act, 2000, and its amendments
              </li>
              <li className='mt-[21px]'>
                Electronic records generated by [Matrimony Website Name] are
                considered legally valid under the Information Technology Act,
                2000.
              </li>
            </ul>
          </div>
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                Using our HappyMilan services, you agree to protect, indemnify,
                and hold HappyMilan and its affiliates harmless from any loss,
                damage, liability, claim, or demand, including reasonable
                attorney's fees, due to improper service use. This obligation
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                In any dispute related to the Site or Service, using the Site
                implies your unequivocal agreement that Indian laws will govern,
                and the exclusive jurisdiction will be with the Competent Courts
                in Mumbai, India
              </li>
            </ul>
          </div>
          ...
          <div className='w-[100%]'>
            ...
            <ul style={ContentText}>
              <li>
                We aim to offer a secure and enjoyable matrimony and dating
                platform in India. While we strive for a positive experience,
                our liability is limited by law. Users are urged to engage
                responsibly, and the platform assumes no responsibility for
                consequential damages or disputes. Use of our services implies
                agreement with the outlined limitations in our terms and
                conditions.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={ContentText}>
              ...
              <li className='mt-[21px]'>
                ...
                grievanceofficer@happymilan.com
              </li>
              <li className='mt-[5px]'>
                <span className='text-[#0F52BA]'>Support:</span> +91 00000 10000
              </li>
              <li className='mt-[21px]'>
                By clicking "I Accept" or by using our services, you acknowledge
              ...
              <li className='mt-[21px]'>
                This Agreement becomes effective on the date of your
                registration
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={ContentText}>
              <li>
                For complaints or disputes, kindly reach out to our customer
                support through written correspondence or email, including a
                digital signature, at:
              </li>
              <li className='mt-[21px]'>
                <span className='text-[#0F52BA]'>Email:</span>{' '}
                grievanceofficer@happymilan.com
              ...
              <li className='mt-[5px]'>
                <span className='text-[#0F52BA]'>Grievance Officer:</span> Jit
                Shrimali
              </li>
              <li className='mt-[5px]'>
                <span className='text-[#0F52BA]'>Availability :</span> 10am to
                6pm IST, Mon-Fri (Sat & Sun Public Holiday)
              </li>
            </ul>
          </div>
          <div className='w-[100%] h-[1px] bg-[#CCC] mt-[20px]'></div>
          <div className=' pt-[20px]'>
            <h1 style={ContentText2}>
              This Agreement, an electronic document under the Information
              Technology Act, 2000, and related rules, is computer-generated and
