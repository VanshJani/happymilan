...
function Credentials () {
  ...
  const { details: data } = useSelector(state => state.user)
    ...
    useEffect(() => {
      ...
      if (localStorageData) {
        ...
        if (localStorageData) {
          ...
          setEmail(maskedEmail || data?.email)
      ...
      case 1:
        return (
          <>
            ...
            <h1 className='text-[10px] xl:text-[12px] mt-[30px] lg:mt-[35px] xl:mt-[40px] font-medium'>
              Current Email
            </h1>
            ...
            <div className='px-[10%] lg:px-[5%] 2xl:px-[10%]'>
              <div className=''>
                ...
                <div className=' mt-[10px]  '>
                  <h1 className='  text-[10px] lg:text-[11px] xl:text-[12px] text-center   font-medium'>
                    Verification code sent {Email2}
                  </h1>
                </div>
              </div>
              ...
              <div className='flex justify-center mt-[20px] md:mt-[25px] lg:mt-[40px] xl:mt-[50px]'>
                <h1 className=' text-[10px] lg:text-[13px] xl:text-[14px] text-center md:w-[300px] text-[#0F52BA] font-medium'>
                  Resend in 57 sec{' '}
                </h1>
              </div>
        ...
        <div className=''>
          ...
          <div className='w-[500px] lg:w-[640px] xl:w-[700px]'>
            <h1 style={TextHeading} className=' mt-[20px]'>
              This menu enables users to update and manage authentication info,
              ensuring secure access to the account or system
            </h1>
          </div>
          ...
          <div>
            <div className='mt-[15px] xl:mt-[20px] flex  '>
              <h1 className='text-[15px] xl:text-[17px] mb-[5px] w-[550px] lg:w-[620px] xl:w-[680px] font-medium'>
                Email
              </h1>
              <div
