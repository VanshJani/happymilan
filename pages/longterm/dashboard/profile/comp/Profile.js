...
import { STATUSES, fetchTotalLikes } from '../../../../../store/reducers/MyProfile';
...
function Profile() {
    ...
    const { data: addressData } = useSelector((state) => state.myprofile.profileData.adressData)
    const { data: ProfessionalData } = useSelector((state) => state.myprofile.profileData.ProfessionalData)
                                ...
                                <ul className='flex justify-center items-center space-x-[8px] md:space-x-[40px]'>
                                    ...
                                    <li>
                                        <div className='flex items-center space-x-[10px]'>
                                            ...
                                            <h1 style={Text2} className='dark:text-[#FFF] lg:text-[12px] md:text-[12px] text-[11px]'>{capitalizeFirstLetter(ProfessionalData?.jobTitle) || "NA"}</h1>
                                        </div>
                                    </li>
                                    <li>
                                        <div className='flex items-center space-x-[10px]'>
                                            <Image loading='lazy' alt='loactionIcon' width={10} height={12} src='/assests/dashboard/icon/location-icon.svg' />
                                            <h1 style={Text2} className='dark:text-[#FFF] lg:text-[12px] md:text-[12px] text-[11px]'>{capitalizeFirstLetter(addressData?.currentCity) || "NA"}</h1>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div style={{ width: '347px', height: '450px', position: 'relative', borderRadius: "10px" }}>
                    ...
                    <div className='z-10 absolute bottom-6 grid place-items-center w-full'>
                        <ul className=' flex space-x-[19px]'>
                            <li onClick={handleOpen} className='cursor-pointer w-[38px] h-[38px] grid place-items-center bg-[#ffffff] hover:bg-[#F2F7FF] rounded-full'>
                            ...
                            <li onClick={() => console.log("")} className='cursor-pointer hover:bg-[#F2F7FF] w-[38px] h-[38px] bg-[white] rounded-full grid place-items-center'>
