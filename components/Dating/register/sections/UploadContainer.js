...
function UploadContainer({ datingForm, updateDatingFormData }) {
        ...
        validFiles.forEach((file) => {
            ...
            reader.onload = () => {
                updateDatingFormData({
                    ...
                    upload: {
                        ...datingForm.upload,
                        images: datingForm?.upload?.images
                            ? [...datingForm.upload.images, ...selectedFiles] // Append new images to existing ones
                            : [...selectedFiles],
    ...
    }, [datingForm, updateDatingFormData]);
