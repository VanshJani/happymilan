...
const Pagination = ({ URL, currentPage, totalPages, onPageChange }) => {
    ...
    <div className=' relative left-[-5px] lg:left-[0px] flex pt-[50px] space-x-[40px] justify-center items-center w-[90%] 2xl:w-full xl:w-full'>
      {currentPage > 1 && (
        <button
          ...
          className={`${
            darkMode ? 'hover:bg-[#21212f]' : ''
          }duration-300 cursor-pointer w-[44px] h-[44px] border-[1px] dark:border-[#FFF] border-[black] grid place-items-center rounded-full`}
        >
          {darkMode ? (
            <Image
              width={7}
