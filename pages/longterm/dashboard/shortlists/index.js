    ...
    <>
      ...
      <Layout Show={false} >
        <div id='centerlized-content' className='2xl:block xl:block lg:block hidden'>
          ...
          {!Listtype ?
            <UserProfile /> : <GridUserProfile />}


        </div>
        <div className='block lg:block 2xl:hidden xl:hidden relative top-[60px] pl-[15px]'>
          <h1 className='p-[5px] relative 2xl:left-[40px] lg:left-[10px] xl:left-[55px]'><span style={Text6}> <span className='text-[#0F52BA]'> 124 </span> Profiles Found For You!</span></h1>
        </div>
