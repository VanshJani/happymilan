  ...
  const ContentObj = [
    {
      ...
      content:
        'Boost your profile by sharing more about yourself, your interests, and your ideal partner. A detailed profile improves your chances of finding the perfect match'
    },
    {
      id: 2,
      Title: 'Stay Safe and Secure',
      content:
        'Your privacy is our priority. Take advantage of our security features, and be assured that your information is in safe hands'
    },
    {
      id: 3,
        ...
        <div className='z-[50] 2xl:w-[450px] 2xl:h-[516px] xl:w-[350px] xl:h-[400px] bg-[#FFF] rounded-[14px]'>
          ...
          >
            <div className='grid place-items-center w-full h-full'>
              ...
              <h1 className='text-[18px] noImage-select' style={CongratsText}>
                Congratulations
              </h1>
            </div>
          </div>
          ...
          >
            <div>
              <h1
                ...
                style={Heading}
              >
                {ContentObj[currentContentIndex].Title}
              </h1>
            </div>
            <div className='text-center 2xl:w-[357px] xl:w-[300px] lg:w-[357px] h-[84px]'>
              <p
                ...
                style={Text}
              >
                {ContentObj[currentContentIndex].content}
              </p>
            </div>
            <div className='space-x-[20px] flex'>
              <div
                className={`${
                  currentContentIndex == 0 ? 'bg-[#8225AF]' : 'bg-[#E8E8E8]'
                } w-[42px] h-[1px]`}
              ></div>
              <div
                className={`${
                  currentContentIndex == 1 ? 'bg-[#8225AF]' : 'bg-[#E8E8E8]'
                } w-[42px] h-[1px]`}
              ></div>
              <div
                className={`${
                  currentContentIndex == 2 ? 'bg-[#8225AF]' : 'bg-[#E8E8E8]'
                } w-[42px] h-[1px]`}
              ></div>
            </div>
