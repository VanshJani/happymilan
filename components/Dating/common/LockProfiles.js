        ...
        <>
            <div style={ShadowBox} className='dark:bg-[#242526] bg-[#FFF] flex flex-col space-y-[25px] w-[300px] h-[235px]'>
                <div className='ml-[20px] mt-[10px] p-[10px]'>
                    <h1 style={Text1} className='text-[12px] dark:text-[#FFF] text-[#000]'>See who visited you</h1>
                </div>
                <div className='flex items-center justify-center space-x-[18px]'>
                    ...
                    <div className='flex flex-col justify-center items-center space-y-[10px]'>
                        <div className='grid place-items-center w-[47px] h-[47px] rounded-[50px] relative top-[-5px] bg-[#FFF] dark:bg-[#5E5E5E]'>
                ...
                <div className='text-center'>
                    <button style={Text1} className='dark:text-[#FFF] text-[#000] text-[14px] rounded-[23px] w-[149px] h-[44px]  border-[1px] border-[#8225AF]'>Unlock Profiles</button>
                </div>
            </div>
        </>
    )
