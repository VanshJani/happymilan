        ...
        <>
          <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] xl:mt-[20px] mr-[20px] space-x-[10px]'>
            <ul className='flex space-x-[10px]'>
              <li>
                <h1
                  className={`${styles.BoldText} text-[#000] dark:text-[#EDEDED] text-[16px] 2xl:text-[16px] xl:text-[14px]`}
                >
                  Accepted
                </h1>
              </li>
        ...
        <>
          <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] lg:mt-0 xl:mt-[20px] mr-[20px] space-x-[10px]'>
            ...
            <button
              ...
              className={`group hover:opacity-90 w-[134px] h-[40px] rounded-[22px] dark:bg-[#141516] dark:text-[#EDEDED] ${
                Requeststatus?.status == 'requested'
                  ? 'bg-[#EDEDED] text-[black] dark:text-[#EDEDED] dark:bg-[#141516]'
                  : ' dark:hover:text-[#FFF] text-[#000]'
              }  text-[#000] dark:hover:text-[#FFF]`}
              style={RequestText}
