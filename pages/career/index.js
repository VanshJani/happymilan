...
function index () {
  ...
  return (
    <>
      ...
      <div className='w-full h-full 2xl:pt-[120px] xl:pt-[100px] pt-[100px] mt-[0px] space-y-[50px] px-[20px] lg:px-[0px]'>
        <div className='pb-[0px] lg:pb-[120px]'>
              ...
              <ul className='flex space-x-[27px]'>
                <li>
                  <Image
                    ...
                    height={0}
                    alt='image-1'
                    src={'/assests/career/img-1.svg'}
                    className='lg:w-[194px] lg:h-[439px] w-[150px] h-[395px]'
                  />
                </li>
                <li>
                  <Image
                    ...
                    height={0}
                    alt='image-1'
                    src={'/assests/career/img-2.svg'}
                    className='lg:w-[194px] lg:h-[439px] w-[150px] h-[395px]'
                  />
                </li>
              </ul>
            </div>
            <div className='lg:w-[556px] w-[500px] space-y-[30px] md:space-y-[45px]'>
              <h1 className='lg:text-[48px] text-[28px]' style={Heading}>
                Embark on Your Career Journey with Us
              </h1>
              <p className='lg:text-[24px] text-[20px]' style={Content}>
                Explore our current job openings and take the next step towards
                a rewarding IT career. Join us for professional growth,
        ...
        <div className='w-full h-full pt-[10px] md:pb-[40px]'>
          <div className='text-center'>
            <h1 className='text-[28px] md:text-[34px]' style={Text}>
              Current Openings
            </h1>
          </div>
          <div className='space-y-[50px] md:space-y-[90px]'>
            <div className='pl-[50px] pr-[50px] pt-[40px] md:pt-[68px]'>
                    ...
                    <>
                      <li className='2xl:w-[348px] xl:w-[348px] lg:w-[300px] 2xl:h-[190px] xl:h-[190px] lg:h-[160px] w-[348px] h-[190px] border-[1px] cursor-pointer duration-100 hover:border-[#8225AF] border-[#DCDCDC] rounded-[14px] pl-[20px]'>
                        <div className='flex flex-col justify-evenly h-full w-full'>
                          <div
                            className='2xl:w-[57px] 2xl:h-[57px] xl:w-[57px] xl:h-[57px] lg:w-[55px] lg:h-[55px] w-[57px] h-[57px] rounded-full  grid place-items-center'
                            ...
                            <ul className='flex space-x-[60px]'>
                              <li style={Text2} className='flex space-x-[10px]'>
                                <Image
                                  ...
                                  width={8}
                                  height={10}
                                  src='/assests/Black/remote.svg'
                                />
                                <span>{res?.worksetup}</span>
                              </li>
                              <li style={Text2} className='flex space-x-[10px]'>
                                <Image
                                  loading='lazy'
            ...
            <div className='text-center'>
              <button
                onClick={handleOpen}
                style={BtnText}
                className=' hover:bg-[#E7F0FF] lg:w-[181px] lg:h-[55px] w-[170px] h-[45px] border-[1px] border-[#8225AF] rounded-[28px]'
              >
                Send Your CV
              </button>
            </div>
      ...
      >
        <Box
          className='w-[90%] pb-[20px] md:pb-[0px] md:w-[556px] md:h-[606px] top-[50%] left-[50%]'
          sx={style}
        >
          <div className=''>
            <div className='absolute right-[40px] top-[30px]'>
              ...
              >
                <path
                  d='M1.38462 18L0 16.6154L7.61539 9L0 1.38462L1.38462 0L9 7.61539L16.6154 0L18 1.38462L10.3846 9L18 16.6154L16.6154 18L9 10.3846L1.38462 18Z'
                  fill='black'
                />
              </svg>
            </div>
              ...
              <div className='grid place-items-center w-full'>
                <ul className='w-[85%] space-y-[30px]'>
                  <li className='space-y-[10px]'>
                    ...
                    <input
                      type='text'
                      className='hover:border-[#000] pl-[30px] w-full h-[50px] border-[1px] border-[#CDCDCD] rounded-[10px]'
                    />
                  </li>
                  <li className='space-y-[10px]'>
                  ...
                  <li className='space-y-[10px]'>
                    ...
                    <DynamicSelect
                      styles={CareerPageStyle}
                      className='w-[full]'
                      options={designationOptions}
                    />
                  </li>
                  <li>
                    <span className='relative left-[5px]' style={AttachCV}>
                      Attach a CV
                    </span>
                  </li>
                  <li>
                    <button
                      id='grad-btn'
                      className='w-full h-[55px] rounded-[27.5px]'
                      style={btnText2}
                    >
                      Submit
                    </button>
