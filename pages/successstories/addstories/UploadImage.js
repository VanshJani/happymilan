  ...
  return (
    <>
      <div className='relative top-[80px] flex h-full justify-center flex-wrap w-full lg:w-full 2xl:w-[300px] xl:w-[415px]  pt-[0px] lg:pt-0  gap-y-[20px] gap-x-[17px]'>
        {ImagesData?.length > 0 ? (
          <>
            <div className='w-[300px] h-[350px] border-[1px] rounded-[10px] border-gray-300'>
              ...
              <div
                className={`flex justify-end mt-[5px] ${
                  ImagesData.length >= 1 ? 'hidden' : ''
                }`}
                {...getRootProps()}
              >
                <input {...getInputProps()} className='hidden' />
                <Image
                  onMouseEnter={() => SetImageHover({ UploadImageHover: true })}
                  onMouseLeave={() =>
                    SetImageHover({ UploadImageHover: false })
                  }
                  alt='drag-drop'
                  width={34.818}
                  height={24}
                  ...
                  src={
                    ImageHover.UploadImageHover
                      ? '/assests/profile/after-imageupload-icon.svg'
                      : '/assests/profile/before-imageupload-icon.svg'
                  }
                />
              </div>
            </div>
            ...
            >
              ...
              <div className='flex justify-center flex-col items-center h-full'>
                ...
                <h1
                  ...
                  style={TitleText}
                >
                  Select or drag Wedding Photo
                </h1>
              </div>
            </div>

            <div>
              <h1 style={Text3}>Max. 1 Photo (Supported file jpeg png)</h1>
            </div>
          </>
        )}
      </div>
