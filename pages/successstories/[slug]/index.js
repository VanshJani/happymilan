                                        ...
                                        <div className='w-full h-[110px] rounded-[14px]'>
                                            <div>
                                                <div className='h-[110px]'>
                                                    ...
                                                    <textarea style={{ resize: "none" }} maxLength={200} className='hover:border-[#000] border-[1px] border-[#E9E9E9] rounded-[100px] outline-none pl-[50px] pt-[20px] w-full h-[58px]' placeholder='Share your wishes or comments' />
                                                </div>
                                            </div>
                                            <div className='absolute grid place-items-end relative top-[-20px] right-[10px]'>
                                                <button id='grad-button' className='text-[14px] w-[81px] h-[40px] rounded-[20px] text-[white]'>Send</button>
                                            </div>
                                        </div>

                                    </div>

                                    <div className='ml-[5%] 2xl:w-[834px] xl:w-full lg:w-[834px] mt-[45px]'>
                                        <div className='relative left-[-60px] 2xl:left-[-20px] xl:left-[-20px] 2xl:w-full xl:w-full  xl:w-full m-[0px] flex justify-between'>
                                            ...
                                            <div className='flex space-x-[5px] pr-5'>
