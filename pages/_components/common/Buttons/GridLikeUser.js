        ...
        return (
            <div className='mt-[20px] pb-[10px]'>
                <div className='flex space-x-[15px] justify-center'>
                    <div>
                        <div className="Like-button w-[63px] h-[44px] grid place-items-center border-[1px] border-[#9E28D7] rounded-[22px]">
                    ...
                    <div>
                        <div onClick={HandleShortlist} className="shortlist-button w-[63px] h-[44px] grid place-items-center border-[1px] border-[#FFBC47] rounded-[22px]">
                            {/* <svg class="the-like-icon" width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.1914 17.8002L8.80064 16.5341C3.86113 12.055 0.600098 9.1009 0.600098 5.4754C0.600098 2.52129 2.92119 0.200195 5.8753 0.200195C7.54418 0.200195 9.14593 0.977089 10.1914 2.20477C11.2368 0.977089 12.8386 0.200195 14.5075 0.200195C17.4616 0.200195 19.7827 2.52129 19.7827 5.4754C19.7827 9.1009 16.5216 12.055 11.5821 16.5437L10.1914 17.8002Z" />
                            </svg> */}
                            <svg class="the-shortlist-icon" xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                                <path d="M9.26316 14.1448L14.9878 17.6L13.4686 11.088L18.5263 6.70653L11.8661 6.14147L9.26316 0L6.66021 6.14147L0 6.70653L5.05768 11.088L3.53853 17.6L9.26316 14.1448Z" />
                            </svg>
                        </div>
                    </div>
                    <div>
                        <div className="group right-swipe-icon w-[63px] h-[44px] grid place-items-center border-[1px] border-[#7045EB] rounded-[22px]">
