...
function EducationTab () {
  ...
  const { loading, data } = useSelector(
    state => state.myprofile.profileData.EducationData
  )
                ...
                <div className='grid place-items-center'>
                  <div className='w-[90%] m-[12px] grid grid-cols-2 grid-rows-2 gap-[32px]'>
                    <div>
                      ...
                      >
                        {data?.degree
                          ? capitalizeFirstLetter(data.degree)
                          : 'NA'}
                      </h1>
                    </div>
                    <div>
                      ...
                      >
                        {data?.collage
                          ? capitalizeFirstLetter(data.collage)
                          : 'NA'}
                      </h1>
                    </div>
                    <div>
                      ...
                      <h1
                        ...
                        className='dark:text-[#FFF]  2xl:text-[16px]  xl:text-[14px] text-[14px]'
                      >
                        {data?.city ? capitalizeFirstLetter(data.city) : 'NA'}
                      </h1>
                    </div>
                    <div>
                      <p
                      ...
                      <h1
                        ...
                        className='dark:text-[#FFF]  2xl:text-[16px]  xl:text-[14px] text-[14px]'
                      >
                        {data?.state ? capitalizeFirstLetter(data.state) : 'NA'}
                      </h1>
                    </div>
                    <div>
                      <p
