...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_D_3A_5CHM_5Chappymilan_main_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
var lib = __webpack_require__(752);
...
function middleware(request) {
    const token = (0,lib/* getCookie */.ej)("authtoken", {
        req: request
    });
    let profileType = (0,lib/* getCookie */.ej)("UserProfile", {
        req: request
    });
    const em = (0,lib/* getCookie */.ej)("email", {
        req: request
    });
    ...
    if (protectedRoutes.some((route)=>request.nextUrl.pathname.startsWith(route))) {
        ...
        if (!profileType) {
            (0,lib/* deleteCookie */.kT)("UserProfile", {
                req: request
            });
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=D%3A%5CHM%5Chappymilan-main&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_D_3A_5CHM_5Chappymilan_main_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
...
__webpack_unused_export__ = exports.kT = exports.d8 = exports.ej = exports.$1 = void 0;
var cookie_1 = __webpack_require__(200);
