...
import {
  ...
  RESET_EMAIL_PASSWORD_SECOND_STEP,
  RESET_EMAIL_PASSWORD_SUCCESS_FIRST_STEP,
  ...
  RESET_STEPS,
  SIGNUP_FIRST_STEP,
  SIGNUP_FIRST_STEP_FAILURE,
  SIGNUP_FIRST_STEP_SUCCESS,
  SIGNUP_SECOND_STEP,
  SIGNUP_SECOND_STEP_FAILURE,
  SIGNUP_SECOND_STEP_SUCCESS,
  SIGNUP_THIRD_STEP,
  SIGNUP_THIRD_STEP_FAILURE,
  SIGNUP_THIRD_STEP_SUCCESS
} from '../type'
...
export const SubmitPasswordAction = credentials => {
  return async dispatch => {
    ...
    axios
      ...
      .then(response => {
        dispatch({
          type: SIGNUP_THIRD_STEP_SUCCESS,
          payload: {
            step: 3,
