...
import {
  GET_PLANS_BY_NAME_FAILURE,
  GET_PLANS_BY_NAME_REQUEST,
  GET_PLANS_BY_NAME_SUCCESS,
  GET_UPGRADE_PLANS,
  GET_UPGRADE_PLANS_BY_ID,
  GET_UPGRADE_PLANS_BY_ID_FAILURE,
  GET_UPGRADE_PLANS_BY_ID_SUCCESS,
  GET_UPGRADE_PLANS_FAILURE,
  GET_UPGRADE_PLANS_SUCCESS
} from '../type'
...
export const GetPlansByName = PlanName => {
  return async dispatch => {
    ...
    axios
      ...
      .then(response => {
        dispatch({
          type: GET_PLANS_BY_NAME_SUCCESS,
