...
function NavBar({ handleSearch }) {
    ...
    const navList = (
        <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 lg:justify-end lg:gap-x-[50px]">
            ...
            >
                <Image alt="img" width={26} height={26} className="cursor-pointer" onClick={toggleDrawer('right', true)} loading="lazy" layout="responsive" style={{ width: 'auto', height: "auto" }} src={darkMode ? "/assests/dashboard/icon/chat-icon-dark.svg" : "/assests/dashboard/icon/chat-icon-light.svg"} />
                                ...
                                <div className="relative left-[-10px] pt-[0px] flex items-center flex-col space-y-[23px]">
                                    <ul style={Text4} className=" dark:text-[#FFF] pl-[0px] text-[#000] space-y-[8px]">
                                        ...
                                        <li className="w-[230px] h-[34px] p-[10px] pl-[15px] hover:bg-[#F3F8FF] dark:hover:bg-[#18191a] rounded-[100px]  flex items-center space-x-[10px]">
                                            ...
                                            <Link className="relative left-[5px]" href="/longterm/dashboard/seting/credentials">Account Settings</Link>
                                        </li>
                                        <li className="w-[230px] h-[34px] p-[10px] pl-[15px] hover:bg-[#F3F8FF] dark:hover:bg-[#18191a] rounded-[100px]  flex items-center space-x-[10px]">
                                            ...
                                            <Link className="relative left-[5px]" href="/longterm/dashboard/seting/privacyseting">Privacy Setting</Link>
                                        </li>
