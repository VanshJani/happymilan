                                                    ...
                                                    <div className="pr-[8px]">
                                                        <ul className='flex justify-evenly space-x-[26px] pr-[10px] pt-[10px]'>
                                                            ...
                                                            <li className={`cursor-pointer hover:bg-[#F2F7FF] dark:hover:bg-[#383838]  items-center rounded-[17px] flex space-x-[10px] top-[-8px] p-[5px] relative left-[5px]`}>
                                                                <MatchScoreModal user={res?.friend?.friendList} />
                                                            </li>
                                    ...
                                    <div key={index} className="relative 2xl:left-[40px] xl:left-[55px] lg:left-[10px] left-[40px]">
                                        <div style={profileStyles?.Box} className={`flex m-[10px] lg:w-[590px] 2xl:w-[631px] 2xl:h-[294px] xl:w-[540px] xl:h-[284px] bg-[#FFF]`}>
                                            ...
                                            <div className='w-full pt-[15px] 2xl:pt-[15px] xl:pt-[20px]'>
                                                <div className='flex justify-between  h-[50px]'>
                                                    <div>
                                                        <Link href={`/longterm/dashboard/${res.id || res?._id}`} ><h1 className={`${styles?.ProfileName} text-[#000] dark:text-[#FFF] 2xl:text-[20px] xl:text-[15px] text-[15px]`}>{res?.friend?.name}</h1></Link>
                                                        <h1 style={profileStyles?.statusText} className={`text-[#7A7A7A]`}>Online now</h1>
                                                    </div>
                                                    <div className="pr-[8px]">
                                                        <ul className='flex justify-evenly space-x-[26px] pr-[10px] pt-[10px]'>
                                                ...
                                                <div className='mt-[10px] 2xl:mt-[10px] xl:mt-[5px] pl-[2px]'>
                                                    <div id="user-card">
                                                        <ul id="user-card-grid">
                                                            ...
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px] text-[#000] dark:text-[#FFF]' style={profileStyles?.ListText}>
                                                                <Image loading='lazy' alt='mark' width={15} height={14} src={darkMode ? "/assests/Black/RightTickWhite.svg" : '/assests/Black/RightTick.svg'} className='inline pr-[5px]' />
                                                                {res?.friend?.address?.currentCity || "NA"}, {res?.friendList?.address?.currentCountry || "NA"}
                                                            </li>
                                                            <li className='text-[14px] 2xl:text-[14px] xl:text-[13px] text-[#000] dark:text-[#FFF]' style={profileStyles?.ListText}>
                                                                <Image loading='lazy' alt='mark' width={15} height={14} src={darkMode ? "/assests/Black/RightTickWhite.svg" : '/assests/Black/RightTick.svg'} className='inline pr-[5px]' />
                                                                {res?.friend?.userProfessional?.jobTitle || "NA, NA"}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div className='mt-[20px] 2xl:mt-[20px] xl:mt-[15px]'>
                                                        <ShowMore userid={res?.friend?.id || res?.friend?._id} text={(res?.friend?.writeBoutYourSelf ? res?.friend?.writeBoutYourSelf : "NA")} maxLength={100} />
                                                    </div>
                                                </div>
                                                <div className='flex justify-end items-center mt-[20px] 2xl:mt-[20px] xl:mt-[20px] mr-[20px] space-x-[10px]'>
                                                    <ul className='flex space-x-[10px] items-center'>
                                                        <li><h1 className={`${profileStyles?.BoldText} text-[#000] dark:text-[#FFF] text-[16px] 2xl:text-[16px] xl:text-[14px]`}>Sent</h1></li>
